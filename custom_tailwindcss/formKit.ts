export default {
  ...
  //!!! NOTE SOME OF THE STYLES NEEDED TO BE DEFINED IN @assets/css/formKit-PrimeVue-overrides.css due to tailwind limitations! !!!
  global: {
    ...
    input:
      "appearance-none bg-transparent focus:outline-none focus:ring-0 focus:shadow-none py-1.5 px-2 rounded transition",
  ...
  "family:button": {
    input:
      "$reset flex justify-center items-center bg-blue-600 text-white text-sm font-normal py-2.5 px-6 rounded hover:bg-blue-700 hover:shadow-sm transition-all duration-75 focus:outline-2 focus:outline-blue-600 focus:outline-offset-2",
    wrapper: "",
