    ...
    <div>
        ...
        <Dialog v-model:visible="visible" maximizable header="Header" :style="{ width: '25rem' }"
            ...
            <div class="m-0">
                ...
                <FormWrapper :zodSchema="userSchema" :handleSubmit="submitForm" submitLabel="Create">
                    <div class="space-y-2 mb-5">
                        <FormKit class="w-full" type='primeInputText' name='email' validation='required|email'
                            placeholder='Email'>
                        </FormKit>
                        <FormKit class="w-full" type='primeInputText' name='name' validation='required|length:3'
                            placeholder='Name'>
                        </FormKit>
                        <FormKit class="w-full" type='primePassword' name='password' validation='required|length:6'
                            toggleMask :feedback="true" placeholder='Password'>
                        </FormKit>
                        <FormKit class="w-full" type='primePassword' name='password_confirm'
                            validation='required|confirm' toggleMask placeholder='Repeat password'>
                        </FormKit>
