export default {
    ...
    bodyrow: ({ context, props }) => ({
        class: [
            ...
            { 'odd:bg-surface-0 odd:text-surface-600 dark:odd:bg-surface-800 even:bg-surface-50 even:text-surface-600 dark:even:bg-surface-800/65': context.stripedRows },
