<template>
    <div class="relative">
        <div ref="wrapperRef" class="textarea-wrapper">
            <div ref="textareaRef" :name="name" :id="name" v-html="value" @input="updateValue"
                ...
                :aria-describedby="name + '-optional'" :required="required" :rows="rows || 2" contenteditable="true" />
...
const updateValue = () => {
    if (textareaRef.value) {
        value.value = textareaRef.value.innerHTML;
    }
};
</script>
