<template>
    <ConfirmDialog :group="group" :pt="pt">
        <template #container="{ message, acceptCallback, rejectCallback }">
            <div
                class="flex flex-col w-full border-b bg-surface-0 dark:bg-surface-700 rounded-md border-surface-200 dark:border-surface-700">
                <div class="shadow">
                    <div class="px-5 py-7">
                        <div>
                            <div class="flex items-center gap-4 mb-5">
                                <div
                                    ...
                                    <i :class="message.icon, message.iconClass" class="text-2xl"></i>
                                </div>
                                <span class="font-medium text-md">{{ message.header }}</span>
                            </div>
                        </div>
                        <div>
