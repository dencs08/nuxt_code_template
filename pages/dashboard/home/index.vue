                ...
                <template #content>
                    ...
                    bary: 'relative z-20 w-[9px] top-0 rounded-full bg-surface-200/40 dark:bg-surface-700 hover:bg-primary-500/25 hover:dark:bg-surface-600 cursor-pointer transition-colors'
                        ...
                        <p>
                            ...
                            officiis hic accusamus? Lorem ipsum dolor sit, amet consectetur adipisicing elit. Eaque sit
                            quis
                            sed
                            vero blanditiis beatae! Accusantium officiis laborum omnis molestias itaque, incidunt
                            aperiam,
                            quibusdam dignissimos voluptate exercitationem voluptatem iste iusto? Lorem ipsum dolor sit
                            amet
                            consectetur adipisicing elit. Eveniet minima earum tempore magnam, facilis saepe molestias
                            temporibus cupiditate, eius ratione illo voluptatem amet expedita aut, pariatur dignissimos
                            eos
                            ex
